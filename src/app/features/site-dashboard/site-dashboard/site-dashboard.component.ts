...
export class SiteDashboardComponent implements OnInit, OnChanges, OnDestroy {
  ...
  detailCards = {
    gridCp: {
      ...
      currentL1: { grid: '-', acMeter: '-' } as GridCpComparisonValue,
      currentL2: { grid: '-', acMeter: '-' } as GridCpComparisonValue,
      currentL3: { grid: '-', acMeter: '-' } as GridCpComparisonValue,
  ...
  private syncDeviceSelection(details: any): void {
    ...
    this.detailCards = {
      gridCp: {
        ...
        currentL1: { grid: '-', acMeter: '-' },
        currentL2: { grid: '-', acMeter: '-' },
        currentL3: { grid: '-', acMeter: '-' },
  ...
  private applyPacketToLiveData(event: DeviceDataEvent): void {
    ...
    this.detailCards = {
      gridCp: {
        ...
        currentL1: this.gridCpValue(payload.lineACurrent, payload.extMainL1Current, 'A', 1, [65535]),
        currentL2: this.gridCpValue(payload.lineBCurrent, payload.extMainL2Current, 'A', 1, [65535]),
        currentL3: this.gridCpValue(payload.lineCCurrent, payload.extMainL3Current, 'A', 1, [65535]),
      ...
      generator: {
        ...
        currentL1: this.gridCpValue(payload.gensetCurrentL1, payload.extGensetL1Current, 'A', 1, [65535]),
        currentL2: this.gridCpValue(payload.gensetCurrentL2, payload.extGensetL2Current, 'A', 1, [65535]),
        currentL3: this.gridCpValue(payload.gensetCurrentL3, payload.extGensetL3Current, 'A', 1, [65535]),
